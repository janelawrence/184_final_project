...
void ClothSimulator::load_textures() {
  ...
  std::vector<std::string> cubemap_fnames = {
    m_project_root + "/textures/cube2/lostvalley_up.bmp",
    m_project_root + "/textures/cube2/lostvalley_up.bmp",
    m_project_root + "/textures/cube2/lostvalley_up.bmp",
    m_project_root + "/textures/cube2/lostvalley_down.bmp",
    m_project_root + "/textures/cube2/lostvalley_up.bmp",
    m_project_root + "/textures/cube2/lostvalley_up.bmp"
  };
...
void ClothSimulator::drawWireframe(GLShader &shader) {
  ...
  //shader.setUniform("u_color", nanogui::Color(1.0f, 1.0f, 1.0f, 1.0ff), false);
